...
2. Clone this repository by running `git clone https://github.com/zerothebahdman/nestjs-prisma.git` or [directly create your own GitHub repository using this template](https://github.com/ahmetuysal/nestjs-prisma/generate).
